...
for learn_rate in [0.1, 0.01, 0.001]:
    for iterations in [10, 100, 1000, 10000, 100000]:
        ...
        print("\nPLA (Learn-Rate: {}, Iterations: {}): Duration: {}"
              .format(learn_rate, iterations, end-start))
        pla.print_statistics()
for learn_rate in [0.1, 0.01, 0.001]:
    for iterations in [10, 100, 1000, 10000, 100000]:
        start = time.time()
        ...
        print("\nPocket (Learn-Rate: {}, Iterations: {}): Duration: {}"
              .format(learn_rate, iterations, end-start))
        pocket.print_statistics()
